...
object Calculations {
    ...
    fun calculateTimeBetweenDates(startDate: String, endDate: String): String {
//        val endDate = timeStampToString((System.currentTimeMillis()))
        ...
        return when {
            minutes < 240 -> "Started $minutes minutes ago"
            hours < 48 -> "Started $hours hours ago"
            days < 61 -> "Started $days days ago"
            months < 24 -> "Started $months months ago"
            else -> "Started $years years ago"
        }
    }
